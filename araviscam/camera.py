...
from araviscam import __version__ as araviscam_version
...
class BlackflyCameraSystem(CameraSystem):
    ...
    def __version__(self):
        ...
        return araviscam_version or "0.99.0"
...
class BlackflyCamera(
    BaseCamera, ExposureTypeMixIn, ImageAreaMixIn, CoolerMixIn, GainMixIn
):
